/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 74: /***/ (module, __unused_webpack_exports, __nccwpck_require__) => {
    ...
    /***/ 27: /***/ (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      class ConfigLoader {
        ...
        load(filePath, debug = false) {
          ...
          const schemaContent = fs.readFileSync(
            __nccwpck_require__.ab + "config.schema.json",
            "utf8",
          );
  ...
  async function run() {
    ...
    if (!(shortShaDeep > 0)) {
      core.info(
        `⚠️ Invalid short-sha value: ${shortShaDeep}, will be used default -> 7`,
      );
    }
