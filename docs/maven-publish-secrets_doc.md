...
jobs:
  pom:
    uses: netcracker/qubership-workflow-hub/.github/workflows/update-pom-release.yml@v1.0.4
    with:
      file: pom.xml
      revision: ${{ github.event.inputs.revision }}

  git_release:
    uses: netcracker/qubership-workflow-hub/.github/workflows/create-github-release.yml@v1.0.4
    needs: pom
    with:
      revision: ${{ github.event.inputs.revision }}
  ...
  maven:
    uses: netcracker/qubership-workflow-hub/.github/workflows/maven-publish.yml@v1.0.4
    needs: git_release
    with:
